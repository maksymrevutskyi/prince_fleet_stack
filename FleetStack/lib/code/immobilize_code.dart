...
class immobilize_code extends GetxController{
  ...
  showvehicles() async{
    ...
    if (result["respcode"] == true) {
      ...
      print("printing the vehicle list");
      print(vehiclelist);
  ...
  startvehicle(String imei) async{
   ...
   await Future.delayed(Duration(seconds: 3), () {
    ...
    if (result["respcode"] == true) {
      ...
      print(data);
      if(data.length>0){
        List<dynamic> retrievalList = jsonDecode(data[0]["data"]).entries.toList();

...
class map_code extends GetxController {
  ...
  addvehicles() async {
    ...
    if (result["respcode"] == true) {
      ...
      for (var i = 0; i < vehiclelist.length; i++) {
        if (vehiclelist[i]["lastlatitude"] != null &&
            vehiclelist[i]["lastlongitude"] != null) {
          final point = LatLng(
            ...
            Marker(
              ...
              builder: (ctx) => GestureDetector(
                child: Column(
                  children: [
                    Transform.rotate(
                      ...
                      angle: FleetStack.angle(
                          vehiclelist[i]["preLatitude"],
                          vehiclelist[i]["preLongitude"],
                          vehiclelist[i]["lastlatitude"],
                          vehiclelist[i]["lastlongitude"]),
                      child: isripple.value == true
                          ? RippleWave(
                              color:
                                  vehiclelist[i]["status"].toString() == "Stop"
                                      ? appcolor.stopripple
                                      : vehiclelist[i]["status"].toString() ==
                                              "Running"
                    ...
                    islabel.value == true
                        ? Container(
                            ...
                            child: Text(
                              vehiclelist[i]["vehicleno"].toString(),
                              style: TextStyle(
                                fontSize: 10,
                                color: Colors.black,
                              ),
                ...
                onTap: () {
                  ...
                  Get.to(() => livetracking(
                      deviceid:
                          '${vehiclelist[i]["deviceid"]},${vehiclelist[i]["lastlatitude"]},${vehiclelist[i]["lastlongitude"]},${vehiclelist[i]["vehicletype"]},${vehiclelist[i]["status"]}'));
                },
              ),
            ),
          );
        ...
        //lastlatitude   lastlongitude  preLatitude preLongitude
        ...
        //     width: 30,
        //     point: point,
        //     builder: (ctx) => const Icon(Icons.access_alarms),
        //   ),
        // );
      }
  ...
  getlocalsettings() async {
    islabel.value =
        (await FleetStack.getlocal("islabel") == 'false') ? false : true;
    isgeofence.value =
    ...
    print('printing my own location ${ismylocation.value} ');
